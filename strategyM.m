function portfolio=strategyV(thisCrsp, marketSigma, mr)

    marketSigma = sqrt(252)*marketSigma; % annualize volatility


    % How to make port2: M (momentum firms)
    port2 = thisCrsp(thisCrsp.momentumRank >= mr(1) & thisCrsp.momentumRank <= mr(2), :);
