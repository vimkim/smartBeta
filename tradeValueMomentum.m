function portfolio=tradeValueMomentum(thisDate,crsp,percent, optionalArgument)
% Function: tradeValueMomentum
% Author: 
...
thisCrsp = thisCrsp(thisCrsp.valueRank >= (1 - percent),:);
...
assetTable = makeAssetsTable(thisDate,42,crsp);
assetTable(isnan(assetTable)) = 0;
pv = portvar(assetTable)
