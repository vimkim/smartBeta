function portfolio=strategy4(thisCrsp, marketSigma)
    ...
    mom10 = thisCrsp(thisCrsp.momentumRank >= 0.10,:);
    %% among thisCrsp, extract below 10% size firms
    mom10 = addRank('size', mom10);
    mom10size25 = mom10(mom10.sizeRank >= 0.10,:);

    %% extract top 10% value firms
    value10 = thisCrsp(thisCrsp.valueRank >= 0.75,:);
