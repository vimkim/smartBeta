...
% This function performs a trade based on a specific strategy, which we named SM_V.
%
% What is SM_V and how does it perform:
% M stands for momentum, S stands for size and V stands for value.
% We create two sub portfolios called MS and V.
    % SM is a portfolio of momentum firms within size firms. This is named 'port1' in this function.
