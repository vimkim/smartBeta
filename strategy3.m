function portfolio=strategy3(thisCrsp, marketSigma)
    ...
    mom25 = thisCrsp(thisCrsp.momentumRank >= 0.75,:);
    %% among thisCrsp, extract below 10% size firms
    mom25 = addRank('size', mom25);
    mom25size025 = mom25(mom25.sizeRank <= 0.25,:);

    %% extract top 10% value firms
    value25 = thisCrsp(thisCrsp.valueRank >= 0.75,:);
